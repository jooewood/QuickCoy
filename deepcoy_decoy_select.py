...
# -*- coding: utf-8 -*-
"""
Created on Tue May 10 18:32:29 2022
...
file = '/home/zdx/project/decoy_generation/result/Imrie_decoy_select_demo/P38-alpha_example_decoys.smi'
outfile = '/home/zdx/project/decoy_generation/result/Imrie_decoy_select_demo/P38-alpha_example_decoys-selected_test.smi'
dataset='ALL'
...
dec_results = select_and_evaluate_decoys(file, outfile)

def select_and_evaluate_decoys(file, outfile, dataset='ALL', num_cand_dec_per_act=100, num_dec_per_act=50, max_idx_cmpd=10000, min_active_size=10):
    print("Processing: ", file)
    dec_results = [file]
    dec_results.append(dataset)
    # Read data
    data = decoy_utils.read_paired_file(file)
